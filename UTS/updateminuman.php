<?php
  ...
  if ($_SERVER['REQUEST_METHOD'] === 'GET') {
      if (isset($_GET['idbarang'])) {
          ...
          $query = "SELECT * FROM minuman WHERE idbarang = '$id_upd'";
  ...
  if ($_SERVER['REQUEST_METHOD'] === 'POST') {
      ...
      $harga = $_POST['harga'];
      //query SQL
      $sql = "UPDATE minuman SET namabarang='$namabarang', kategori='$kategori', jumlahstok='$jumlahstok', harga='$harga' WHERE idbarang='$idbarang'";
      ...
      header('Location: dataminuman.php?status='.$status);
  }
    ...
    <div class="container-fluid">
      <div class="row">
        ...
        <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4">
          ...
          <h2 style="margin: 30px 0 30px 0;">Update Data Minuman</h2>
          <form action="updateminuman.php" method="POST">
            <?php while($data = mysqli_fetch_array($result)): ?>
            <div class="form-group">
              <label>ID Minuman</label>
              <input type="text" class="form-control" placeholder="ID Minuman" name="idbarang" value="<?php echo $data['idbarang'];  ?>" required="required" readonly>
            </div>
            <div class="form-group">
              <label>Nama Minuman</label>
              <input type="text" class="form-control" placeholder="Nama Minuman" name="namabarang" value="<?php echo $data['namabarang'];  ?>" required="required">
            </div>
            <div class="form-group">
